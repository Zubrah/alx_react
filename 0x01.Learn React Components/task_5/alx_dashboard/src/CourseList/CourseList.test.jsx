...
describe('CourseList', () => {
    test('renders the course list table', () => {
        ...
        expect(courseListHeaders).toHaveLength(3);
        ...
        expect(courseListRows).toHaveLength(5); // Including the header row
        expect(courseListRows[1]).toHaveTextContent('Course nameCredit');
        //expect(courseListRows[1]).toHaveTextContent('60');
        expect(courseListRows[2]).toHaveTextContent('ES660');
